...
const AboutMe = (props) => {
    return (
        <div className="pb-16">
            <h2 className=" mb-8 ml-8 sm:ml-12 text-5xl font-bold">About Me.</h2>
            <img className="rounded-3xl ml-8 sm:ml-12 w-64" src={profile} alt=""/>
            <div className="ml-16 mr-8 -mt-8 sm:ml-24 sm:mr-12 rounded-3xl bg-white bg-opacity-70 bd-blur p-8 ">
                <h3 className="text-2xl mb-4 font-bold">Hugo Sundberg</h3>
